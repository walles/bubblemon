...
private func createContext(width: size_t, height: size_t) -> CGContext? {
  ...
  let zBitmapContextRef = CGContext(data: nil, width: width, height: height, bitsPerComponent: 8, bytesPerRow: bytesPerRow, space: rgb, bitmapInfo: (kCGImageAlphaPremultipliedLast as? CGBitmapInfo))
